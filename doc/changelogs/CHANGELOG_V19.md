...
* \[[`86cbb61136`](https://github.com/nodejs/node/commit/86cbb61136)] - **deps**: upgrade npm to 9.5.0 (npm team) [#46673](https://github.com/nodejs/node/pull/46673)
...
* \[[`fbcec67cd5`](https://github.com/nodejs/node/commit/fbcec67cd5)] - **doc**: add debadree25 to collaborators (Debadree Chatterjee) [#46716](https://github.com/nodejs/node/pull/46716)
...
* \[[`106ac53e2b`](https://github.com/nodejs/node/commit/106ac53e2b)] - **(SEMVER-MINOR)** **src**: add initial support for single executable applications (Darshan Sen) [#45038](https://github.com/nodejs/node/pull/45038)
* \[[`c3897bfd9b`](https://github.com/nodejs/node/commit/c3897bfd9b)] - **(SEMVER-MINOR)** **src**: allow optional Isolate termination in node::Stop() (Shelley Vohr) [#46583](https://github.com/nodejs/node/pull/46583)
...
* \[[`7392cd0e2b`](https://github.com/nodejs/node/commit/7392cd0e2b)] - **(SEMVER-MINOR)** **stream**: add abort signal for ReadableStream and WritableStream (Debadree Chatterjee) [#46273](https://github.com/nodejs/node/pull/46273)
...
* \[[`07d8690c36`](https://github.com/nodejs/node/commit/07d8690c36)] - **benchmark**: add trailing commas in `benchmark/path` (Antoine du Hamel) [#46628](https://github.com/nodejs/node/pull/46628)
...
* \[[`d22ba91457`](https://github.com/nodejs/node/commit/d22ba91457)] - **build**: add GitHub Action for coverage with --without-intl (Rich Trott) [#37954](https://github.com/nodejs/node/pull/37954)
* \[[`7899dbf9a3`](https://github.com/nodejs/node/commit/7899dbf9a3)] - **build**: do not disable inspector when intl is disabled (Rich Trott) [#37954](https://github.com/nodejs/node/pull/37954)
* \[[`c67dcc945f`](https://github.com/nodejs/node/commit/c67dcc945f)] - **crypto**: don't assume FIPS is disabled by default (Michael Dawson) [#46532](https://github.com/nodejs/node/pull/46532)
* \[[`86cbb61136`](https://github.com/nodejs/node/commit/86cbb61136)] - **deps**: upgrade npm to 9.5.0 (npm team) [#46673](https://github.com/nodejs/node/pull/46673)
* \[[`094b47798c`](https://github.com/nodejs/node/commit/094b47798c)] - **deps**: update corepack to 0.16.0 (Node.js GitHub Bot) [#46710](https://github.com/nodejs/node/pull/46710)
* \[[`cc1ef01efe`](https://github.com/nodejs/node/commit/cc1ef01efe)] - **deps**: update undici to 5.20.0 (Node.js GitHub Bot) [#46711](https://github.com/nodejs/node/pull/46711)
* \[[`8822874046`](https://github.com/nodejs/node/commit/8822874046)] - **deps**: update ada to v1.0.1 (Yagiz Nizipli) [#46550](https://github.com/nodejs/node/pull/46550)
...
* \[[`fbcec67cd5`](https://github.com/nodejs/node/commit/fbcec67cd5)] - **doc**: add debadree25 to collaborators (Debadree Chatterjee) [#46716](https://github.com/nodejs/node/pull/46716)
* \[[`c07511b237`](https://github.com/nodejs/node/commit/c07511b237)] - **doc**: move bcoe to emeriti (Benjamin Coe) [#46703](https://github.com/nodejs/node/pull/46703)
* \[[`76f5ce5a17`](https://github.com/nodejs/node/commit/76f5ce5a17)] - **doc**: add response.strictContentLength to documentation (Marco Ippolito) [#46627](https://github.com/nodejs/node/pull/46627)
* \[[`2c86cb54b8`](https://github.com/nodejs/node/commit/2c86cb54b8)] - **doc**: remove unused functions from example of `streamConsumers.text` (Deokjin Kim) [#46581](https://github.com/nodejs/node/pull/46581)
...
* \[[`9b23309f53`](https://github.com/nodejs/node/commit/9b23309f53)] - **doc,lib,src,test**: rename --test-coverage (Colin Ihrig) [#46017](https://github.com/nodejs/node/pull/46017)
* \[[`07dfa3c966`](https://github.com/nodejs/node/commit/07dfa3c966)] - **esm**: misc test refactors (Geoffrey Booth) [#46631](https://github.com/nodejs/node/pull/46631)
* \[[`338c8f66f3`](https://github.com/nodejs/node/commit/338c8f66f3)] - **http**: add note about clientError event (Paolo Insogna) [#46584](https://github.com/nodejs/node/pull/46584)
...
* \[[`53fe48023d`](https://github.com/nodejs/node/commit/53fe48023d)] - **lib**: add trailing commas in `internal/process` (Antoine du Hamel) [#46687](https://github.com/nodejs/node/pull/46687)
* \[[`3d2988ec00`](https://github.com/nodejs/node/commit/3d2988ec00)] - **lib**: do not crash using workers with disabled shared array buffers (Ruben Bridgewater) [#41023](https://github.com/nodejs/node/pull/41023)
* \[[`4222e589e1`](https://github.com/nodejs/node/commit/4222e589e1)] - **lib**: delete module findPath unused params (sinkhaha) [#45371](https://github.com/nodejs/node/pull/45371)
* \[[`39d7b7d0b9`](https://github.com/nodejs/node/commit/39d7b7d0b9)] - **lib**: enforce use of trailing commas in more files (Antoine du Hamel) [#46655](https://github.com/nodejs/node/pull/46655)
* \[[`16c507b7a8`](https://github.com/nodejs/node/commit/16c507b7a8)] - **lib**: enforce use of trailing commas for functions (Antoine du Hamel) [#46629](https://github.com/nodejs/node/pull/46629)
...
* \[[`8590eb4830`](https://github.com/nodejs/node/commit/8590eb4830)] - **(SEMVER-MINOR)** **lib**: add aborted() utility function (Debadree Chatterjee) [#46494](https://github.com/nodejs/node/pull/46494)
* \[[`fdc588c3df`](https://github.com/nodejs/node/commit/fdc588c3df)] - **meta**: update AUTHORS (Node.js GitHub Bot) [#46624](https://github.com/nodejs/node/pull/46624)
...
* \[[`a22f1f90f8`](https://github.com/nodejs/node/commit/a22f1f90f8)] - **process**: print versions by sort (Himself65) [#46428](https://github.com/nodejs/node/pull/46428)
* \[[`106ac53e2b`](https://github.com/nodejs/node/commit/106ac53e2b)] - **(SEMVER-MINOR)** **src**: add initial support for single executable applications (Darshan Sen) [#45038](https://github.com/nodejs/node/pull/45038)
* \[[`c3897bfd9b`](https://github.com/nodejs/node/commit/c3897bfd9b)] - **(SEMVER-MINOR)** **src**: allow optional Isolate termination in node::Stop() (Shelley Vohr) [#46583](https://github.com/nodejs/node/pull/46583)
* \[[`9a5a274f28`](https://github.com/nodejs/node/commit/9a5a274f28)] - **src**: remove icu usage from node\_string.cc (Yagiz Nizipli) [#46548](https://github.com/nodejs/node/pull/46548)
...
* \[[`e77d538d32`](https://github.com/nodejs/node/commit/e77d538d32)] - **(SEMVER-MINOR)** **src**: allow embedder control of code generation policy (Shelley Vohr) [#46368](https://github.com/nodejs/node/pull/46368)
* \[[`014028f58a`](https://github.com/nodejs/node/commit/014028f58a)] - **stream**: add trailing commas in webstream source files (Antoine du Hamel) [#46685](https://github.com/nodejs/node/pull/46685)
* \[[`f3b6084d80`](https://github.com/nodejs/node/commit/f3b6084d80)] - **stream**: add trailing commas in stream source files (Antoine du Hamel) [#46686](https://github.com/nodejs/node/pull/46686)
* \[[`7392cd0e2b`](https://github.com/nodejs/node/commit/7392cd0e2b)] - **(SEMVER-MINOR)** **stream**: add abort signal for ReadableStream and WritableStream (Debadree Chatterjee) [#46273](https://github.com/nodejs/node/pull/46273)
...
* \[[`673f76a612`](https://github.com/nodejs/node/commit/673f76a612)] - **test**: fix `test-net-autoselectfamily` for kernel without IPv6 support (Livia Medeiros) [#45856](https://github.com/nodejs/node/pull/45856)
* \[[`7606136c7c`](https://github.com/nodejs/node/commit/7606136c7c)] - **test**: fix assertions in test-snapshot-dns-lookup\* (Tobias Nießen) [#46618](https://github.com/nodejs/node/pull/46618)
* \[[`b5d2a21346`](https://github.com/nodejs/node/commit/b5d2a21346)] - **test**: cover publicExponent validation in OpenSSL (Tobias Nießen) [#46632](https://github.com/nodejs/node/pull/46632)
* \[[`db266dfad8`](https://github.com/nodejs/node/commit/db266dfad8)] - **test**: add WPTRunner support for variants and generating WPT reports (Filip Skokan) [#46498](https://github.com/nodejs/node/pull/46498)
* \[[`aff78cdbed`](https://github.com/nodejs/node/commit/aff78cdbed)] - **test**: add trailing commas in `test/pummel` (Antoine du Hamel) [#46610](https://github.com/nodejs/node/pull/46610)
...
* \[[`f4fe58b8ce`](https://github.com/nodejs/node/commit/f4fe58b8ce)] - **test,crypto**: update WebCryptoAPI WPT (Filip Skokan) [#46575](https://github.com/nodejs/node/pull/46575)
* \[[`c2d735e13b`](https://github.com/nodejs/node/commit/c2d735e13b)] - **test\_runner**: parse non-ascii character correctly (Mert Can Altın) [#45736](https://github.com/nodejs/node/pull/45736)
* \[[`e97e796d14`](https://github.com/nodejs/node/commit/e97e796d14)] - **test\_runner**: allow nesting test within describe (Moshe Atlow) [#46544](https://github.com/nodejs/node/pull/46544)
...
* \[[`3a6934974b`](https://github.com/nodejs/node/commit/3a6934974b)] - **tools**: fix bug in `prefer-primordials` lint rule (Antoine du Hamel) [#46659](https://github.com/nodejs/node/pull/46659)
* \[[`06d032ba9d`](https://github.com/nodejs/node/commit/06d032ba9d)] - **tools**: fix update-ada script (Yagiz Nizipli) [#46550](https://github.com/nodejs/node/pull/46550)
* \[[`55d7288a89`](https://github.com/nodejs/node/commit/55d7288a89)] - **tools**: add a daily wpt.fyi synchronized report upload (Filip Skokan) [#46498](https://github.com/nodejs/node/pull/46498)
